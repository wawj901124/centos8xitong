...
class NodeConfigXadmin():
    ...
    def get_fromsets_with_inlines(self,request,obj=None):
        #只想在the_change_view中展示一个特殊的inline
        for inline in self.get_inline_instances(request,obj):
            if isinstance(inline,ConfigCollectFactorInline) and obj is None:
                continue
